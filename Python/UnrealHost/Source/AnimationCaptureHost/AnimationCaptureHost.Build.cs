...
public class AnimationCaptureHost : ModuleRules
{
    public AnimationCaptureHost(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PrivateDependencyModuleNames.AddRange(new[] { "AnimationCore", "AnimationDataController", "MeshDescription", "StaticMeshDescription", "SkeletalMeshDescription", "SkeletalMeshUtilitiesCommon" });
    }
}
